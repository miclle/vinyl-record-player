...
文档更新：2026-09-22；模型版本：v0.4-sc2103-layout。用户确认扬声器来自 Shockwave SC-2103，原低音箱、卫星箱和倒相管均已遗失，授权按唱机外廓重新设计。该版交付空间方案及可换管试验结构，尚未完成声学调谐或加工放行。
...
当前 CAD 中左右各为约 1.14 L 的密闭试验腔，没有卫星箱倒相管或可封堵接口。这是缺少单元参数时的试装起点，不代表已经证明密闭更合适，也不代表有独立低音单元就可以省略全频腔调谐。原机古典版报道记载卫星箱也有倒相孔，见[设计依据](design-basis.md#自行设计与估算)。
