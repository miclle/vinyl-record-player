...
- [整机与外壳（15 页）](output/pdf/01-assembly-and-enclosure.pdf)：木板整数备料汇总、闭盖六面图、障板局部剖视、外壳零件及底板／后板开孔定位。
...
图纸标明长 X、宽 Y、高 Z、厚度或厚度状态，并补充已有开孔、定位和同形件数量。五种板件的 25 个孔及后板沉台已分别标注孔径、局部孔位、必要的深度和加工面；障板孔位使用沿前表面量取的 S 尺寸。未知的壁厚与安装尺寸不作推定；当前仍是概念与空间核对图。详见[读图说明与重新生成方法](docs/drawing-pack.md)。
