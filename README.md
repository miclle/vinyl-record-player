...
低音腔几何毛容积约 **4.62 L**，扣除所有已建模占用（含实心安装包络和倒相管）后保守净容积约 **4.08 L**；左右全频腔各约 **1.14 L**。这些是 CAD 空间估计，尚未扣吸音材料、支柱、密封件及线缆，不是实测声学容积。原箱和倒相管已遗失，没有 T/S 参数；管径、管长与左右密闭方案均为待测初值。详细坐标、拆装方式和验证边界见 [SC-2103 音腔设计](docs/audio-layout.md)。
