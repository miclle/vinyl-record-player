...
'''
    ...
    def test_all_books_complete_with_position_tables_and_stable_part_codes(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            stock_text=first.pages[1].extract_text()
            for code in ('W01','W02','W03','W04','W06','W07','W08','W09','W10','W11'):
                self.assertIn(code,stock_text)
            self.assertIn('W05',stock_text)
            self.assertLess(stock_text.index('W10'),stock_text.index('W11'))
